...
/** CSI Data Register (dword, 8126 only) */
#define RTL_CSIDR 0x64

/** CSI Address Register (dword, 8126 only) */
#define RTL_CSIAR 0x68
#define RTL_CSIAR_FLAG         0x80000000UL /**< Read/write flag */
...
struct realtek_nic {
	...
	int have_ocp;
	/** RTL8125 MAC version (0 = not an RTL8125/RTL8126) */
	unsigned int mac_ver;
	/** RTL8126 PHY configuration method (0 = not an RTL8126) */
	unsigned int mcfg;
	/** PCI device (for CSI access) */
